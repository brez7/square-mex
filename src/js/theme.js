        ...
        [].forEach.call(navbar, function(el, i){
            addListenerMulti(el, 'mouseenter mouseleave click', function(e){
                if(window.innerWidth > 991.98) {
                    var dropdown = el.querySelector('[data-bs-toggle="dropdown"]'),
...
var Photoswipe = (function() {
    ...
    var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
        ...
        var dataOptions = JSON.parse(galleryElement.parentNode.parentNode.getAttribute('data-options')) || JSON.parse(galleryElement.parentNode.getAttribute('data-options')) || JSON.parse(galleryElement.getAttribute('data-options'));
...
var CounterUp = (function() {
    ...
    function init(elem) {
        ...
        var counter = new countUp.CountUp(elem, to, options);
    ...
    if(countup.length > 0) {
        fetchInject([
            '../assets/vendor/countup.js/dist/countUp.umd.js'
        ]).then(() => {
    ...
    function init(elem) {
        ...
        elem.addEventListener('click', function() {
            ...
            [].forEach.call(target, function(t, i){
                ...
                var counter = new countUp.CountUp(t, to);
